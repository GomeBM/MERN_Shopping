...
//   ); // Use productId instead of productName
...
//         },
//         body: JSON.stringify({ _id: productId }), // Send _id in request body
//       });
...
//           "Content-Type": "application/json",
//         },
//         body: JSON.stringify({ ...product }), // Send product data including _id
//       });
...
//     setProductId(""); // Clear productId after submission
//     setProduct({
//       _id: "",
//       title: "",
//       price: "",
...
//           Update Product
//         </button>
//         <button className="submit-product-btn" onClick={handleDeleteProduct}>
//           DELETE Product
//         </button>
//         {showPopup.show && (
//           <Popup
